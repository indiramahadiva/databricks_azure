...
BASE_DIR = "/Volumes/supply_chain_yt/default/raw"
...
@dp.table(name="supply_chain_yt.bronze.raw_supply_chain", comment="Raw supply chain data for DataCo",table_properties={
